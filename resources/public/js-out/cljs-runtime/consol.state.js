goog.provide('consol.state');
consol.state.dev_state_override = (function consol$state$dev_state_override(){
...
consol.state.fetch_state_BANG_ = (function consol$state$fetch_state_BANG_(){
if(cljs.core.truth_(consol.state.dev_state_override())){
return Promise.resolve(consol.state.dev_state_override());
} else {
...
//# sourceMappingURL=consol.state.js.map
