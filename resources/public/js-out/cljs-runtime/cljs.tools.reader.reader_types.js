...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7814 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7814(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7815 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7815(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7816 = (function (reader,ch){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7816(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7817 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7817(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7818 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7818(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7819 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7819(reader);
}
});
...
var G__7852 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__7853 = s.append(c);
c = G__7852;
s = G__7853;
continue;
}
